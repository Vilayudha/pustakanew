...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 29 Nov 2023 pada 18.17
...
CREATE TABLE `pinjam` (
  ...
  `ststus` enum('pinjam','kembali') NOT NULL,
...
(17, 'vila', 'vilayudha123@gmail.com', 'pro1701274441.jpg', '$2y$10$xVKy4.iuq6m6L8HW18UXQ.kUjsiIKSr30uRFfDGnM2iZj3z55YV7.', 1, 1, 1701096252),
(18, 'yudha', 'yudhavila123@gmail.com', 'pro1701183282.jpg', '$2y$10$.wVq56kUP0fX.nV8L/u1Y.XHe3GEsgEGM1ti.55WDZY75w3KopUJe', 1, 1, 1701182875);
